...
const promos = [
    ...
    },
    {
        ...
        price: '750.000 VNĐ',
        // Unsplash: Phu Quoc island beach – turquoise water, white sand
        image: 'https://images.unsplash.com/photo-1604999565976-8913ad2ddb37?w=600&auto=format&fit=crop&q=80',
    ...
    return (
        <div className="container mx-auto px-4 md:px-8 py-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {promos.map(promo => (
                    <div key={promo.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100 flex flex-col group">
                        <div className="relative h-40 bg-slate-200 overflow-hidden">
                            <img src={promo.image} alt={promo.to} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
